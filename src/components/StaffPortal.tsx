...
export const StaffPortal: React.FC<StaffPortalProps> = ({
  ...
  const handleClockOutSubmit = (e: React.FormEvent) => {
    ...
    const updatedLog = [newHistoryItem, ...clockHistory];
    ...
    setClockOutNotes('');
    addToast(`Clocked Out successfully! Logged ${decimalHours} working hours. Enjoy your rest! 🏡`, 'success');
  };
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                <div className="bg-white p-6 rounded-3xl border border-[#EBDECE] space-y-4 text-left">
                  ...
                  <div className="space-y-3.5">
                            ...
                            return (
                              <div key={log.id} className="p-3 bg-neutral-50 rounded-xl border border-neutral-100 text-left space-y-1">
                                ...
                                <div className="flex justify-between items-center text-[10px] text-neutral-400">
                                  ...
                                  <span className="font-bold text-[8px] uppercase tracking-wider text-emerald-600">
                                    ● Approved
                                  </span>
                                </div>
                              </div>
                    ...
                    {/* cumulative hours badge */}
                    <div className="p-4 bg-stone-900 text-white rounded-2xl flex justify-between items-center">
                      <div>
                        <span className="text-[9px] uppercase tracking-widest opacity-60 font-medium block">Logged This Cycle</span>
                        <span className="text-base font-mono font-bold">
                          {(() => {
                            const totalHrs = clockHistory
                              .filter(ch => ch.employeeId === employee.id)
                              .reduce((acc, curr) => acc + (curr.totalDecimalHours || 0), 0);
                            ...
                            const totalPay = totalHrs * hourlyRate;
                      ...
                      <span className="text-[8px] bg-emerald-500 text-white font-extrabold uppercase px-2.5 py-1 rounded-full tracking-wider">
                        PAYSLIP READY
                      </span>
                    </div>
                  </div>
